...
<html lang="en">
   <head>
      ...
      <title>FoodTiffinLogin - Online Food Ordering Website </title>
      <!-- Favicon Icon -->
                     ...
                     <div class="row">
                        <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                           ...
                           @if ($errors->any())
                            ...
                            {{-- laravel default messages end here--}}
                           ...
                           <form method="POST" action="{{ route('login') }}">
                            @csrf
                              ...
                              <div class="text-center pt-3">
                                <a class="font-weight-bold" href="{{ route('password.request') }}">Forget Password</a>
                              </div>
                              <div class="text-center pt-3">
