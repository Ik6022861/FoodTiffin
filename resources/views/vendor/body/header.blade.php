    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt="" height="24" />
                        <span class="logo-txt">Vendor</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            @php
                ...
                $profileData = App\Models\Vendor::find($id);
            @endphp
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end"
                    ...
                    aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ (!empty($profileData->photo))?url('upload/vendor_images/'.$profileData->photo):url('upload/no_image.jpg') }}"
                        alt="Header Avatar" />
