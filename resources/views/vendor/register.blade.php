                                ...
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt=""
                                            height="28"> <span class="logo-txt">FoodTiffin-VendorRegister</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Welcome Back !</h5>
                                        <p class="text-muted mt-2">Sign up for Vendors to continue to FoodTiffin.</p>
                                    </div>
                                    ...
                                    <form class="mt-4 pt-2" action="{{ route('vendor.register.submit') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
