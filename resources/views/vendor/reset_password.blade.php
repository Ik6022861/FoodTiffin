                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="mt-4" action="{{ route('vendor.reset_password_submit') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="mb-3 mt-4">
                                                <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">Save Changes</button>
                                            </div>
                                        </form>

                                    </div>
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> FoodTiffin   . Crafted with <i class="mdi mdi-heart text-danger"></i> by ExtremeSoft</p>
                                    </div>
                                </div>
                            </div>
                        </div>
